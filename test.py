...
<style>
    ...
    .header-title { font-size:30px; font-weight:800; color:#1a1a2e; margin:12px 0 0; text-align:center; }
    ...
    [data-testid="stSidebar"] { background:linear-gradient(180deg,#f8fafc,#fff); }
</style>
"""
...
with st.sidebar:
    ...
    # 1. Goutallier Classification
    st.markdown('<div class="sidebar-section">', unsafe_allow_html=True)
    st.markdown('<div class="sidebar-title">📖 Goutallier 분류 기준</div>', unsafe_allow_html=True)
    st.markdown("""
    <p style="font-size:11px;color:#777;margin-bottom:10px;line-height:1.6">
        Goutallier et al. (1994) 회전근개 근육 지방 변성 등급<br>
        RoHI: 극하근(Infraspinatus) <strong style="color:#E67E22">Grade ≥ 2 → 3점</strong>
    </p>
    <table class="sb-table">
        <thead><tr><th>Grade</th><th>설명</th><th style="text-align:center">RoHI</th></tr></thead>
        <tbody>
            <tr>
                <td><strong style="color:#27AE60">0</strong></td>
                <td>정상 근육 (No fat)</td>
                <td style="text-align:center;color:#27AE60;font-weight:700">0점</td>
            </tr>
            <tr>
                <td><strong style="color:#2ECC71">1</strong></td>
                <td>약간의 지방 줄무늬 (Some fatty streaks)</td>
                <td style="text-align:center;color:#27AE60;font-weight:700">0점</td>
            </tr>
            <tr style="background:#FFF5EB">
                <td><strong style="color:#E67E22">2</strong></td>
                <td>지방 &lt; 근육 (Fat &lt; Muscle)</td>
                <td style="text-align:center;color:#E67E22;font-weight:700">3점⚠️</td>
            </tr>
            <tr style="background:#FFF0E6">
                <td><strong style="color:#D35400">3</strong></td>
                <td>지방 = 근육 (Fat = Muscle)</td>
                <td style="text-align:center;color:#E67E22;font-weight:700">3점⚠️</td>
            </tr>
            <tr style="background:#FDEBE6">
                <td><strong style="color:#C0392B">4</strong></td>
                <td>지방 &gt; 근육 (Fat &gt; Muscle)</td>
                <td style="text-align:center;color:#E67E22;font-weight:700">3점⚠️</td>
            </tr>
        </tbody>
    ...
    # 2. Work & Sports Activity
    st.markdown('<div class="sidebar-section">', unsafe_allow_html=True)
    st.markdown('<div class="sidebar-title">🔨 노동 활동 수준 분류</div>', unsafe_allow_html=True)
    st.markdown("""
    <p style="font-size:11px;color:#777;margin-bottom:10px;line-height:1.6">
        Kwon et al. (2019) 정의<br>
        RoHI: <strong style="color:#34495E">노동 활동 '높음' → 2점</strong>
    </p>
    <table class="sb-table">
    ...
    <table class="sb-table">
        ...
        <tbody>
            ...
            <tr>
                <td><strong style="color:#E74C3C">높음</strong></td>
                <td>접촉 스포츠 / 무술</td>
                <td style="color:#888">농구, 축구, 테니스, 배구</td>
            </tr>
        </tbody>
    </table>
    <div class="sb-note">
        ...
        • RoHI: <strong>노동 활동만</strong> 점수 반영 (스포츠 활동은 미반영)
    </div>
    """, unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)
    ...
    # 3. Score Detail Table
    st.markdown('<div class="sidebar-section">', unsafe_allow_html=True)
    st.markdown('<div class="sidebar-title">📋 점수별 상세 데이터</div>', unsafe_allow_html=True)
    st.markdown('<p style="font-size:10px;color:#999;margin-bottom:8px">Kwon et al. (2019) 연구 코호트 기준 (n=603)</p>', unsafe_allow_html=True)
...
# MAIN CONTENT — HEADER
# ══════════════════════════════════════════════════════════
st.markdown('<div style="text-align:center;margin-top:4px"><span class="header-badge">Rotator Cuff Healing Index</span></div>',unsafe_allow_html=True)
...
st.markdown("""
<div style="text-align:center;margin-top:20px;padding:12px;font-size:11px;color:#999;line-height:2">
    ...
    <a class="ref-link" href="https://journals.sagepub.com/doi/10.1177/0363546518810763" target="_blank">
        Kwon et al. <em>Am J Sports Med.</em> 2019;47(1):173-180</a><br>
    <a class="ref-link" href="https://www.arthroscopyjournal.org/article/S0749-8063(21)00963-4/fulltext" target="_blank">
        Jackson et al. <em>Arthroscopy.</em> 2022;38(7):2342-2347</a>
</div>
""",unsafe_allow_html=True)
